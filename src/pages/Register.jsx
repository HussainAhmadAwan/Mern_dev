...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Primary API endpoint on port 5050
      const apiUrl = "http://localhost:5050/register";
      ...
      setStatusMsg({
        type: "success",
        text: response.data.message || "User Registered Successfully in MongoDB Atlas!",
      });
      ...
      let msg = "Registration failed. Please make sure the backend server is running on port 5050.";
